...
const TabLabel = (props: TabLabelProps) => {
  ...
  return (
    <div data-classes={`c-${bgColor}-bg c-${fgColor}-fg c-#0003-b fs-10 p-x-10 p-y-6 m-x-3 br-t-10 b-1 b-b-0 m-b--1 z-1`} onClick={props.onClick}>{props.label.toUpperCase()}</div>
  );
};
...
export const TabCollection = (props:TabCollectionProps) => {
  ...
  return (
    <div data-classes='d-f flxg-1 flxd-c o-h'>
      ...
      <div data-classes='d-f flxg-1 p-30 p-t-50 b-0 b-t-1 c-#0003-b o-a'>{panel}</div>
    </div>
  );
};
